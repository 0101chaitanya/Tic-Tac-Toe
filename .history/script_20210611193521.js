...
let eventFun = (function () {
    ...
    let diagonleArray = [arrayCreator(0, 4), arrayCreator(2, 2)];
    console.log(horizontalArray, verticalArray, diagonleArray);
    function checkWin() {

        let checkHorizontal = horizontalArray.map((item, index) => {
            let stack = 0;
