...
let eventFun = (function () {
    ...
    function checkWin() {
        for (i = 0; i < array.length / 3; i++) {
            if (txt(i) || txt(i - 1) || txt(i - 2) !== ('' || undefined) && ((txt(i) || txt(i - 1) || txt(i - 2)) == txt(i + 1 || txt(i) || txt(i - 1) && txt(i + 1) || txt(i) || txt(i - 1) == txt(i + 2) || txt(i + 1) || txt(i))) || ((txt(i) || txt(i - 3) || txt(i - 6) == txt(i + 3) || txt(i) || txt(i - 3) && txt(i + 3) || txt(i) || txt(i - 3) == txt(i + 6) || txt(i + 3) || txt(i))) {
                console.log(txt(i));
            }
