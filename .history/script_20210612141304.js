...
let eventFun = (function() {
    ...
    function init() {
        ...
        (localStorage.getItem("p2") !== null) ? document.getElementById('p2').textContent = localStorage.getItem("p1") + " choose: " + user1Selection: document.getElementById('p1').textContent += ` ` + user1Selection || ' ';
