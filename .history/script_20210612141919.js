...
let eventFun = (function() {
    ...
    function init() {
        ...
        (localStorage.getItem("p2") !== null) ? document.getElementById('p2').textContent = localStorage.getItem("p2") + " choose: " + user2Selection: document.getElementById('p2').textContent += ` ` + user2Selection || ' ';
